...
657 19 ~DisplayInformation 0 516 1321 39 DisplayInformation::~DisplayInformation 0 0 10
/**
 *
 */
46
...
658 18 DisplayInformation 0 260 1321 38 DisplayInformation::DisplayInformation 0 2 13 14 10
/**
 *
 */
130
...
713 15 ~DrawableRegion 0 518 1325 31 DrawableRegion::~DrawableRegion 0 0 10
/**
 *
 */
46
...
737 12 WindowHandle 0 260 1332 26 WindowHandle::WindowHandle 0 2 89 90 22
/**
 *
 */
...
743 8 OSHandle 0 260 1334 32 WindowHandle::OSHandle::OSHandle 0 1 97 197
/**
...
748 16 WindowProperties 0 260 1335 34 WindowProperties::WindowProperties 0 1 101 22
/**
 *
 */
...
750 17 ~WindowProperties 0 516 1335 35 WindowProperties::~WindowProperties 0 0 10
/**
 *
 */
49
...
834 14 ~DisplayRegion 0 518 1343 29 DisplayRegion::~DisplayRegion 0 0 10
/**
 *
 */
44
...
850 15 ~GraphicsOutput 0 518 1346 31 GraphicsOutput::~GraphicsOutput 0 0 10
/**
 *
 */
46
...
958 14 GraphicsEngine 0 260 1368 30 GraphicsEngine::GraphicsEngine 0 1 424 187
/**
...
961 22 GraphicsThreadingModel 0 260 1370 46 GraphicsThreadingModel::GraphicsThreadingModel 0 2 453 454 1249
/**
 *
 */
...
975 23 ~GraphicsThreadingModel 0 516 1370 47 GraphicsThreadingModel::~GraphicsThreadingModel 0 0 0
54
...
1162 21 FrameBufferProperties 0 260 1386 44 FrameBufferProperties::FrameBufferProperties 0 2 471 472 0
165
...
1182 22 ~FrameBufferProperties 0 516 1386 45 FrameBufferProperties::~FrameBufferProperties 0 0 0
52
...
1198 26 ~GraphicsWindowInputDevice 0 516 1387 53 GraphicsWindowInputDevice::~GraphicsWindowInputDevice 0 0 0
60
...
1203 9 TouchInfo 0 260 1389 20 TouchInfo::TouchInfo 0 1 552 0
57
inline TouchInfo::TouchInfo(TouchInfo const &) = default;

1204 10 ~TouchInfo 0 516 1389 21 TouchInfo::~TouchInfo 0 0 0
28
...
1209 31 ~GraphicsWindowProcCallbackData 0 516 1391 63 GraphicsWindowProcCallbackData::~GraphicsWindowProcCallbackData 0 0 0
70
...
1238 19 ~WindowCallbackData 0 516 1395 63 CallbackGraphicsWindow::WindowCallbackData::~WindowCallbackData 0 0 0
70
...
1240 19 ~EventsCallbackData 0 516 1397 63 CallbackGraphicsWindow::EventsCallbackData::~EventsCallbackData 0 0 0
70
...
1248 19 ~RenderCallbackData 0 516 1400 63 CallbackGraphicsWindow::RenderCallbackData::~RenderCallbackData 0 0 0
70
...
1273 11 DisplayMode 0 260 1401 24 DisplayMode::DisplayMode 0 2 608 609 0
112
inline DisplayMode::DisplayMode(void) = default;
inline DisplayMode::DisplayMode(DisplayMode const &) = default;

1274 12 ~DisplayMode 0 516 1401 25 DisplayMode::~DisplayMode 0 0 0
32
...
1278 30 ~DisplayRegionCullCallbackData 0 516 1402 61 DisplayRegionCullCallbackData::~DisplayRegionCullCallbackData 0 0 0
68
...
1282 30 ~DisplayRegionDrawCallbackData 0 516 1403 61 DisplayRegionDrawCallbackData::~DisplayRegionDrawCallbackData 0 0 0
68
DisplayRegionDrawCallbackData::~DisplayRegionDrawCallbackData(void);

1283 23 DisplaySearchParameters 0 260 1404 48 DisplaySearchParameters::DisplaySearchParameters 0 2 619 620 10
/**
 *
 */
155
...
1284 24 ~DisplaySearchParameters 0 516 1404 49 DisplaySearchParameters::~DisplaySearchParameters 0 0 10
/**
 *
 */
56
...
1302 16 MouseAndKeyboard 0 260 1408 34 MouseAndKeyboard::MouseAndKeyboard 0 2 639 640 10
/**
 *
 */
184
...
1305 17 ~MouseAndKeyboard 0 516 1408 35 MouseAndKeyboard::~MouseAndKeyboard 0 0 0
42
...
1309 19 ~NativeWindowHandle 0 516 1410 39 NativeWindowHandle::~NativeWindowHandle 0 0 0
46
 ...
 *
 */ 0 
14 0 0 15 26 1320 657 0 0 1 6 param0 0 1419  
 ...
 * Returns the RenderBuffer::Type that corresponds to a RenderTexturePlane.
 */ 1 5 plane 1 1317  
89 0 0 15 122 1342 0 0 10 /**
 *
 */ 1 4 copy 1 1429  
90 0 0 23 122 1342 0 0 10 /**
 *
...
97 0 0 15 131 1333 0 0 0 1 6 param0 0 1435  
...
101 0 0 39 139 1440 750 0 0 2 4 args 1 1437  4 kwds 1 1437  
 ...
 * make_window_handle() method that returns an appropriate WindowHandle object
 * to wrap the particular OS-specific representation.
 */ 2 4 this 3 1440  13 parent_window 5 1342  
 ...
 * Returns the camera associated with this DisplayRegion, or an empty NodePath
 * if no camera is associated.
 */ 2 4 this 3 1453  14 current_thread 5 1460  
 ...
 * filename, or empty string if the screenshot failed.  The filename is
 * generated by make_screenshot_filename().
 */ 2 4 this 3 1385  6 prefix 5 1418  
235 0 0 6 674 1340 0 0 117 /**
 * Saves a screenshot of the region to the indicated filename.  Returns true
 * on success, false on failure.
 */ 3 4 this 3 1385  8 filename 1 1450  13 image_comment 5 1418  
 ...
 * Also see make_texture_buffer(), which is a higher-level interface for
 * preparing render-to-a-texture mode.
 */ 4 4 this 3 1345  3 tex 1 1364  4 mode 1 1348  8 bitplane 5 1326  
 ...
 * When you are done using the buffer, you should remove it with a call to
 * GraphicsEngine::remove_window().
 */ 7 4 this 3 1345  4 name 1 1418  6 x_size 1 1317  6 y_size 1 1317  3 tex 5 1364  6 to_ram 5 1340  3 fbp 5 1476  
 ...
 * geometry, particularly with TexGenAttrib::M_world_cube_map also in effect,
 * to apply a reflection of everything seen by the camera rig.
 */ 7 4 this 3 1345  4 name 1 1418  4 size 1 1317  10 camera_rig 1 1462  11 camera_mask 5 1477  6 to_ram 5 1340  3 fbp 5 1476  
 ...
 * filename, or empty string if the screenshot failed.  The filename is
 * generated by make_screenshot_filename().
 */ 2 4 this 3 1345  6 prefix 5 1418  
318 0 0 6 606 1340 0 0 304 /**
 * Saves a screenshot of the region to the indicated filename.  The image
 * comment is an optional user readable string that will be saved with the
 * header of the image (if the file format supports embedded data; for example
 * jpg allows comments).  Returns true on success, false on failure.
 */ 3 4 this 3 1345  8 filename 1 1450  13 image_comment 5 1418  
 ...
 * Texture::set_quality_level().
 */ 1 4 this 3 1482  
407 0 0 38 435 1437 0 0 0 1 4 this 3 1482  
 ...
 * this GraphicsEngine.  See GraphicsStateGuardian::set_loader().
 */ 1 4 this 3 1493  
434 0 0 7 503 1345 850 0 0 9 4 this 3 1367  4 pipe 1 1358  4 name 1 1418  4 sort 1 1317  7 fb_prop 1 1471  8 win_prop 1 1441  5 flags 1 1317  3 gsg 5 1350  4 host 5 1345  
 ...
 *
 */ 0 
453 0 0 15 475 1495 975 0 10 /**
 *
 */ 1 4 copy 1 1484  
454 0 0 23 475 1495 975 0 1237 /**
 * The threading model accepts a string representing the names of the two
 * threads that will process cull and draw for the given window, separated by
 * a slash.  The names are completely arbitrary and are used only to
 * differentiate threads.  The two names may be the same, meaning the same
...
472 0 0 15 754 1476 1182 0 0 1 6 param0 0 1471  
...
// record the data incoming on the device. 3 4 this 3 1503  6 button 1 1504  4 time 5 1506  
538 0 0 4 778 1417 0 0 189 /**
 * Records that the indicated button was depressed earlier, and we only just
 * detected the event after the fact.  This is mainly useful for tracking the
 * state of modifier keys.
 */ 3 4 this 3 1503  6 button 1 1504  4 time 5 1506  
539 0 0 4 779 1417 0 0 63 /**
 * Records that the indicated button has been released.
 */ 3 4 this 3 1503  6 button 1 1504  4 time 5 1506  
540 0 0 4 780 1417 0 0 67 /**
 * Records that the indicated keystroke has been generated.
 */ 3 4 this 3 1503  7 keycode 1 1317  4 time 5 1506  
 ...
 * To be called by a particular kind of GraphicsWindow to indicate that the
 * pointer is within the window, at the given pixel coordinates.
 */ 4 4 this 3 1503  1 x 1 1506  1 y 1 1506  4 time 5 1506  
 ...
 * To be called by a particular kind of GraphicsWindow to indicate that the
 * pointer data has changed.
 */ 3 4 this 3 1503  4 data 1 1510  4 time 5 1506  
...
552 0 0 15 799 1513 1204 0 0 1 6 param0 0 1511  
...
609 0 0 15 899 1532 1274 0 0 1 6 param0 0 1421  
 ...
 *
 */ 0 
620 0 0 15 912 1541 1284 0 0 1 6 param0 0 1542  
 ...
 * If the type is not already defined, this will implicitly load the named
 * module, or if module_name is empty, it will call load_aux_modules().
 */ 3 4 this 3 1547  9 type_name 1 1418  11 module_name 5 1418  
...
640 0 0 15 938 1548 1305 0 0 1 6 param0 0 1549  
